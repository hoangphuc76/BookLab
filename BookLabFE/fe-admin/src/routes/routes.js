...
import ManagerRoom from "../features/ManagerRoomForManagerRole/ManageRoomForManager";
import CalendarRoom from "../features/ManagerRoomForManagerRole/CalendarRoom";
...
const privateRoutes = [
  {
    ...
    children: [
      ...
      { path: "Email", component: TemplateEditor },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "helps", component: Helps },
      { path: "ManageRoom", component: ManagerRoom },
      { path: "Room", component: RoomManager },
      {path: "CalendarRoom", component: CalendarRoom}
  ...
  },
  {
    path: '/MET',
    component: MET,
    allowedRoles: [7], // Only allow roleId 2 (Manager)
    children: [
      {
        path: 'bookingImport',
        component: ImportBooking,
