                                    ...
                                    <div
                                        ...
                                        className={`shape_group transition-all duration-300 cursor-pointer
                                            ${isActive
                                                ...
                                                : "bg-[#6B75CC]/5 border-2 hover:bg-gradient-to-br hover:from-[#F8F9FF] hover:to-[#E8EBFF]  hover:shadow-lg hover:shadow-[#6B75CC]/30 hover:transform hover:scale-[1.02]"}
                                            ...
                                            <div className="flex ml-3 mb-6">
                                                {studentInGroup.slice(0, 3).map((student, index) => (
                                                    <img
                                                        key={index}
                                                        src={student.avatar}
                                                        className={`w-9 h-9 object-cover rounded-full ${isActive ? "border-white shadow-md" : "border-[#6B75CC] shadow-sm"
