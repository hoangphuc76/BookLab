...
const RoomDetailPage = () => {
  ...
  const { accountDetail, userId, userCode } = useSelector((state) => state.profile);
  ...
  useEffect(() => {
    ...
    // Rest of the code for API fetching remains the same
  ...
  const handleSendFeedback = async () => {
    const fetchFeedbackAPI = async (feedback) => {
      await apiClient
        ...
        .then((response) => {
          room.rating = rating != 0 ? (room.rating * reviewFeedbacks.filter((f) => f.rating != 0).length + rating) / (reviewFeedbacks.filter((f) => f.rating != 0).length + 1) : room.rating
          const newFeedback = {
        ...
        .catch((error) => {
          ...
          setNotification({
            ...
            message: `Failed to submit feedback: ${error.response?.data?.detail || 'Unknown error occurred'}`,
            autoCloseTime: 5000
          });
        });
    }
  ...
  return (
    <NotificationProvider>
      <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 pt-32 pb-24 space-y-12">
          {/* Room Image Gallery */}
          <div className="aspect-[7/3] max-h-[600px] shadow-2xl rounded-3xl overflow-hidden">
                ...
                <div className="flex space-x-2">
                  ...
                  >
                    <HeartIcon
                      ...
                      className={`h-5 w-5 ${favourite ? "text-red-500" : "text-gray-700"}`}
                    />
                  </button>
                </div>
              </div>
              ...
              <div className="flex items-center border-t border-gray-100 pt-6">
                <div className="flex-shrink-0">
                  <img
                    ...
                    src={room?.managerAvatar ? room?.managerAvatar : `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0xgBPJkpeg_-4nq3JXqjFghG_eAiaopFo5A&s`}
                    alt="Manager"
                  />
                </div>
                <div className="ml-3">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg border border-indigo-100/50 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex items-center p-4 rounded-xl bg-gray-50 hover:bg-indigo-50 transition-colors">
                  ...
                  <span className="font-medium text-gray-700">Virtual equipment</span>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg border border-indigo-100/50 p-6">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-gray-500">Select your rating</span>
                </div>
