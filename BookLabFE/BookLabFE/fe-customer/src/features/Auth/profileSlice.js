  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProfile.fulfilled, (state, action) => {
        ...
        state.userCode = action.payload.accountName;
        state.gmail = action.payload.gmail;
        if (action.payload?.accountDetail) {
          state.username = action.payload.accountDetail.fullName || null;
          state.avatar = action.payload.accountDetail.avatar || null;
