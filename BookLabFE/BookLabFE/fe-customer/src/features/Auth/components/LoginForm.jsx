...
const LoginFormContent = () => {
    ...
    const handleDemoLogin = async () => {
        try {
            ...
            const response = await ApiClient.post('/Authenticate/demo-login', "demo@gmail.com", {
                headers: {
        ...
        <div class={`w-full h-full
            ...
            >
                ...
                <button onClick={login}
                    variant="outline"
                    className="w-full bg-[#1F2E45]/75 p-2 cursor-pointer text-black hover:bg-[#1F2E45] rounded-md flex items-center justify-between gap-2 mb-4"
                >
                ...
                >
                    <div className='flex items-center'>
                        ...
                        <div className='text-white/50 text-xs'> Login with Demo Account</div>
                    </div>
                    <div className='p-2 bg-[#18243A] p-2 rounded-md'>
                        <ArrowRightIcon className='text-white/50' />
                    </div>
