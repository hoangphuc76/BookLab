...
export const googleLoginThunk = createAsyncThunk(
  ...
  async (googleToken, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('https://booklab-demo.runasp.net/odata/Authenticate/google-response', {
        token: googleToken,
...
export const refreshTokenThunk = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://booklab-demo.runasp.net/odata/Authenticate/refresh', null, {
